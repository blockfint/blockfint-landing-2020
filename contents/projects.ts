    ...
    benefits: [
      {
        ...
        title: 'Efficient',
        description: 'the users’ financial transaction, storage and analysis data system.'
      },
      {
  ...
  fiderser: {
    ...
    benefits: [
      ...
      },
      {
        ...
        title: 'Manage',
        description: 'palm trading systematically and collect the information for the future market development.'
      },
      {
  ...
  cu: {
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Preparation for P2P electricity trading including MDMS, Billing and Wheeling charge.'
      }
    ],
    ...
    benefits: [
      {
        ...
        description: 'for newly issued debt securities to trade in the secondary market.',
