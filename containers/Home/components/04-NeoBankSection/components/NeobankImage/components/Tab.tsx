...
function Tab(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 321 209" {...props}>
      <defs>
        <linearGradient id="prefix__b" x1="66.445%" x2="63.807%" y1="46.911%" y2="51.644%">
          <stop offset="0%" stopColor="#E8F7FA" />
          <stop offset="100%" stopColor="#70CACF" />
        </linearGradient>
        <linearGradient id="prefix__c" x1="66.095%" x2="63.796%" y1="46.911%" y2="52.184%">
          <stop offset="0%" stopColor="#C5EFF1" />
          <stop offset="100%" stopColor="#8DD2DC" />
        </linearGradient>
        <filter id="prefix__a" width="250.7%" height="694.7%" x="-75.3%" y="-297.4%" filterUnits="objectBoundingBox">
          <feOffset dx={-32} dy={8} in="SourceAlpha" result="shadowOffsetOuter1" />
        ...
        <filter id="prefix__d" width="106.4%" height="125.8%" x="-3.2%" y="-12.9%" filterUnits="objectBoundingBox">
          <feGaussianBlur in="SourceGraphic" stdDeviation={1.6} />
        </filter>
      </defs>
      <g filter="url(#prefix__a)" transform="translate(85.844 85.538)" strokeWidth={1.6} fill="none" fillRule="evenodd">
        <path
          fill="#8BDEE2"
