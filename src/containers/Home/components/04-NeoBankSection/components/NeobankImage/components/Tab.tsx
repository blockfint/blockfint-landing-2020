...
function Tab(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 321 209" {...props}>
      <defs>
        <linearGradient id="tab_prefix__b" x1="66.445%" x2="63.807%" y1="46.911%" y2="51.644%">
          <stop offset="0%" stopColor="#E8F7FA" />
          <stop offset="100%" stopColor="#70CACF" />
        </linearGradient>
        <linearGradient id="tab_prefix__c" x1="66.095%" x2="63.796%" y1="46.911%" y2="52.184%">
        ...
        <filter id="tab_prefix__d" width="106.4%" height="125.8%" x="-3.2%" y="-12.9%" filterUnits="objectBoundingBox">
